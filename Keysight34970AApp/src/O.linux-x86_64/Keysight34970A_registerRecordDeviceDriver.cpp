...
/* Generated from ../O.Common/Keysight34970A.dbd */
...
int Keysight34970A_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/natsume/Keysight34970A";
...
/* Keysight34970A_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: Keysight34970A_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(Keysight34970A_registerRecordDeviceDriver(*iocshPpdbbase));
}
